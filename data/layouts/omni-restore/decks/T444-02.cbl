      *> MAPTIVA stamped extract skeleton - card T444/02
      *> T444 With - T444/02
      ...
      *> recompile the matrix instead.
       01  T444-02-REC.
           ...
           05  FILLER-006-016               PIC X(11)        *> cols 6-16 Not Used
           05  USAGE-CODE-5-USAGE-CODE-5    PIC X            *> cols 17-17 Opt
           05  WIRE-IND-WIRE                PIC X            *> cols 18-18 Opt
      ...
      *> MOVE list (source master -> card image)
           ...
           MOVE SPACES TO FILLER-006-016
           MOVE <source-field> TO USAGE-CODE-5-USAGE-CODE-5
           MOVE <source-field> TO WIRE-IND-WIRE
