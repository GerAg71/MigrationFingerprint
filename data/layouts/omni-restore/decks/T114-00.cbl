      *> MAPTIVA stamped extract skeleton - card T114/00
      *> T114 Cont - T114/00 Participant Contribution Detail
      ...
      *> recompile the matrix instead.
       01  T114-00-REC.
           ...
           05  RECORD-TYPE-STIHDR           PIC X(7)         *> cols 9-15 Req
           05  PLAN-NUMBER                  PIC X(6)         *> cols 16-21 Req
           05  PARTICIPANT-ID               PIC X(17)        *> cols 22-38 Req
           05  FUND-ID                      PIC X(3)         *> cols 39-41 Opt
           05  TRADE-DATE                   PIC 9(8)         *> cols 42-49 Req
      ...
      *> MOVE list (source master -> card image)
           ...
           MOVE <source-field> TO RECORD-TYPE-STIHDR
           MOVE <source-field> TO PLAN-NUMBER
           MOVE <source-field> TO PARTICIPANT-ID
           MOVE <source-field> TO FUND-ID
