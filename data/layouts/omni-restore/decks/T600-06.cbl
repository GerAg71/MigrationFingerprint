      *> MAPTIVA stamped extract skeleton - card T600/06
      *> T600 Add a Plan - T600/06
      ...
      *> recompile the matrix instead.
       01  T600-06-REC.
           ...
           05  COMPANY-ADDRESS-LINE-2       PIC X(40)        *> cols 9-48 Opt
      ...
      *> MOVE list (source master -> card image)
           ...
           MOVE <source-field> TO COMPANY-ADDRESS-LINE-2
