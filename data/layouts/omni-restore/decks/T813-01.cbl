      *> MAPTIVA stamped extract skeleton - card T813/01
      *> T813 Ppt Hdr Maint - T813/01
      ...
      *> recompile the matrix instead.
       01  T813-01-REC.
           ...
           05  RPT-OPT-REPORT-OPTIONS       PIC X            *> cols 12-12 Opt
           05  DIV-SUB-DIV-SUB              PIC X(4)         *> cols 13-16 Opt
           05  VALIDATE-OVERRIDE            PIC X            *> cols 17-17 Opt
      ...
      *> MOVE list (source master -> card image)
           ...
           MOVE <source-field> TO VALIDATE-OVERRIDE
